 ...
 * @author Gabriel
 */
public class SavingsAccountMenu_GUI extends javax.swing.JFrame {

    /**
     * Creates new form SavingsAccountMenu_GUI
     */
    Client_DAO client;
    public SavingsAccountMenu_GUI() {
        initComponents();
        this.client = Client_DAO.actualClient;
        balance_lbl.setText(Double.toString(client.getBalance("SavingsAccount")));
    }
    ...
    private void initComponents() {
        ...
        deposit_btn.setBounds(160, 100, 90, 32);
        ...
        withdraw_btn.setBounds(160, 150, 90, 32);
        ...
        transfer_btn.setBounds(160, 200, 90, 32);
        ...
        jButton1.setBounds(300, 0, 100, 50);

        jLabel1.setText("Savings Account Menu");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(150, 70, 130, 16);

        jLabel2.setText("Balance:");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(10, 20, 60, 16);
        jPanel1.add(balance_lbl);
        balance_lbl.setBounds(70, 10, 60, 30);
    ...
    private void withdraw_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_withdraw_btnActionPerformed
        client.withDraw("SavingsAccount");
    ...
    private void transfer_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_transfer_btnActionPerformed
        client.transfer("SavingsAccount");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SavingsAccountMenu_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
